...
![Страница шаблона для репозитория](image/13.jpg){#fig:013 width=70%}
...
![Созданный репозиторий](image/15.jpg){#fig:015 width=70%}
...
Проверяю правильность выполнения работы сначала на самом сайте GitHub (рис.[-@fig:024]).
